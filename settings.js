...
// env variable for zero 
process.env.MQTT_ZERO_LED = `${farmName}/${zeroName}/${zero[0]}`;
process.env.MQTT_ZERO_UV = `${farmName}/${zeroName}/${zero[1]}`;
process.env.MQTT_ZERO_IR = `${farmName}/${zeroName}/${zero[2]}`;
...
module.exports = {
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2b$08$97oQkVM3SLvZJXKvANEuZu/UQawUNTCwuOO/wcRQopg5.GygB0u.m",
            permissions: "*"
        }]
    },
